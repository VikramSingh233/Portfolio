...
const Footer = () => {
  return (
    ...
    <div className='md:flex justify-center items-center w-full flex-wrap h-50 bg-white text-white md:gap-10 max-w-screen-2xl dark:bg-slate-800 dark:text-white'>
      <div className='md:flex justify-center items-center w-full flex-wrap h-20   text-white md:gap-10 max-w-screen-2xl dark:bg-slate-800 dark:text-white'>
        <div className='flex flex-col p-2  md:w-auto w-2/3 flex-wrap  my-3'>
          <p className='text-black font-bold mx-auto '>Call</p>
          <Link href="tel:7607928008" className='text-black mx-auto hover:text-orange-700'>7607928008</Link>
        </div>
        ...
        <div className='flex flex-col p-2  md:w-auto w-2/3 flex-wrap  my-3'>
          ...
          <div className='flex gap-4 mx-auto'>
            ...
            <Link href="" className='text-black'>
              <svg className="h-6 w-6 text-slate-700 hover:text-orange-700" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">  <path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z" />  <rect x="2" y="9" width="4" height="12" />  <circle cx="4" cy="4" r="2" /></svg>
            </Link>
            <Link href="" className='text-black'>
      ...
      <div className='flex  md:flex-row justify-center items-center md:w-full md:flex-wrap h-20  text-white md:gap-10 md:mt-0 md:relative dark:bg-slate-800 dark:text-white  max-w-96  mr-5 absolute right-0 flex-col gap-10'>
